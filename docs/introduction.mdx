...
🏖️ **Easy Deployment**: Offers WebSocket, RESTful API, IO console and Voice interfaces for rapid setup of agent-based AI solutions.
...
<CardGroup cols={2}>
  <Card
    ...
    href="installation"
  >
    SuperAgentX installation procedures
  </Card>
  <Card
    title="Quick Start"
    icon="stars"
    href="quickstart"
  >
    Create Your Awesome Multi-Agent Use cases with SuperAgentX
  </Card>
</CardGroup>
