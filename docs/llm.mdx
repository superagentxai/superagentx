...
| Icon                                                                                                                                                                                         | LLM Name          |
|:-----------------------------------------------------------------------------------------------------------------------------------------:                                                   | :---------------  |
| <img src="/images/llms/deepseek.png?raw=True" title="deepseek" height="25" width="25" style={{ margin: 0}} />                   | **DeepSeek**      |
| <img src="/images/llms/openai.png?raw=True" title="OpenAI" height="25" width="25" style={{ margin: 0 }} />                      | **OpenAI**        |
| <img src="/images/llms/azure-icon.png?raw=True" title="Azure OpenAI" height="25" width="25" style={{ margin: 0 }} />            | **Azure OpenAI**  |
| <img src="/images/llms/awsbedrock.png?raw=True" title="AWS Bedrock" height="25" width="25" style={{ margin: 0 }} />             | **AWS Bedrock**   |
| <img src="/images/llms/gemini.png?raw=True" title="Google Gemini" height="25" width="25" style={{ margin: 0 }} />               | **Google Gemini** |
| <img src="/images/llms/meta.png?raw=True" title="Google Gemini" height="25" width="25" style={{ margin: 0 }} />                 | **Meta Llama**    |
| <img src="/images/llms/ollama.png?raw=True" title="Ollama" height="15" width="25" style={{ margin: 0 }} />                      | **Ollama**        |
| <img src="/images/llms/claude-ai-logo.png?raw=True" title="Claude AI" height="25" width="25" style={{ margin: 0 }} />           | **Claude AI**     |
| <img src="/images/llms/mistral-ai-logo.png?raw=True" title="Mistral AI" height="25" width="35" style={{ margin: 0 }} />         | **Mistral AI**    |
| <img src="/images/llms/ibm.png?raw=True" title="IBM WatsonX AI" height="25" width="35" style={{ margin: 0 }} />                 | **IBM WatsonX**   |
