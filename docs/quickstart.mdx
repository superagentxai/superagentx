...
[ERROR] 🚫 arun(): Failed to crawl https://www.starwars.com/databank/han-solo, error: [ERROR] 🚫 crawl(): Failed to crawl
https://www.starwars.com/databank/han-solo: Page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at https://www.starwars.com/databank/han-solo
Call log:
navigating to "https://www.starwars.com/databank/han-solo", waiting until "domcontentloaded"
