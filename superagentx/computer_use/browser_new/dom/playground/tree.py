...
from superagentx.computer_use.browser_new.dom.views import EnhancedDOMTreeNode
...
async def main():
	...
	from superagentx.computer_use.browser_new.browser.events import NavigateToUrlEvent
