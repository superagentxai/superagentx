...
from superagentx.computer_use.browser_new.dom.views import (
	EnhancedDOMTreeNode,
	SerializedDOMState,
)

if TYPE_CHECKING:
	from superagentx.computer_use.browser_new.browser.views import BrowserStateSummary, PageInfo
...
class DOMWatchdog(BaseWatchdog):
		...
		try:
			...
			if self.selector_map and self._dom_service:
				try:
					...
					from superagentx.computer_use.browser_new.dom.debug.highlights import inject_highlighting_script
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from superagentx.computer_use.browser_new.browser.views import PageInfo
