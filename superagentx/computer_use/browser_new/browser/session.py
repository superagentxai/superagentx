...
# It automatically sets CDP logs to the same level as superagentx.computer_use.browser_new logs
from superagentx.computer_use.browser_new.browser.events import (
...
from superagentx.computer_use.browser_new.browser.profile import BrowserProfile
from superagentx.computer_use.browser_new.browser.views import BrowserStateSummary, TabInfo
from superagentx.computer_use.browser_new.dom.views import EnhancedDOMTreeNode, TargetInfo
from superagentx.computer_use.browser_new.utils import _log_pretty_url, is_new_tab_page
...
class CDPSession(BaseModel):
	...
	async def for_target(
		...
		if new_socket:
			...
			logger = logging.getLogger(f'superagentx.computer_use.browser_new.CDPSession.{target_id[-4:]}')
...
class BrowserSession(BaseModel):
	...
	def logger(self) -> Any:
		...
		# 	self._logger = logging.getLogger(f'superagentx.computer_use.browser_new.{self}')
		return logging.getLogger(f'superagentx.computer_use.browser_new.{self}')
	...
	def model_post_init(self, __context) -> None:
		...
		from superagentx.computer_use.browser_new.browser.watchdog_base import BaseWatchdog
	...
	async def kill(self) -> None:
		...
		from superagentx.computer_use.browser_new.browser.events import SaveStorageStateEvent
	...
	async def attach_all_watchdogs(self) -> None:
		...
		from superagentx.computer_use.browser_new.browser.aboutblank_watchdog import AboutBlankWatchdog

		# from superagentx.computer_use.browser_new.browser.crash_watchdog import CrashWatchdog
		from superagentx.computer_use.browser_new.browser.default_action_watchdog import DefaultActionWatchdog
		from superagentx.computer_use.browser_new.browser.dom_watchdog import DOMWatchdog
		from superagentx.computer_use.browser_new.browser.downloads_watchdog import DownloadsWatchdog
		from superagentx.computer_use.browser_new.browser.local_browser_watchdog import LocalBrowserWatchdog
		from superagentx.computer_use.browser_new.browser.permissions_watchdog import PermissionsWatchdog
		from superagentx.computer_use.browser_new.browser.popups_watchdog import PopupsWatchdog
		from superagentx.computer_use.browser_new.browser.screenshot_watchdog import ScreenshotWatchdog
		from superagentx.computer_use.browser_new.browser.security_watchdog import SecurityWatchdog
		# from superagentx.computer_use.browser_new.browser.storage_state_watchdog import StorageStateWatchdog
	...
	async def connect(self, cdp_url: str | None = None) -> Self:
		...
		try:
			...
			from superagentx.computer_use.browser_new.utils import is_new_tab_page
...
# _watchdog_modules = [
# 	'superagentx.computer_use.browser_new.browser.crash_watchdog.CrashWatchdog',
# 	'superagentx.computer_use.browser_new.browser.downloads_watchdog.DownloadsWatchdog',
# 	'superagentx.computer_use.browser_new.browser.local_browser_watchdog.LocalBrowserWatchdog',
# 	'superagentx.computer_use.browser_new.browser.storage_state_watchdog.StorageStateWatchdog',
# 	'superagentx.computer_use.browser_new.browser.security_watchdog.SecurityWatchdog',
# 	'superagentx.computer_use.browser_new.browser.aboutblank_watchdog.AboutBlankWatchdog',
# 	'superagentx.computer_use.browser_new.browser.popups_watchdog.PopupsWatchdog',
# 	'superagentx.computer_use.browser_new.browser.permissions_watchdog.PermissionsWatchdog',
# 	'superagentx.computer_use.browser_new.browser.default_action_watchdog.DefaultActionWatchdog',
# 	'superagentx.computer_use.browser_new.browser.dom_watchdog.DOMWatchdog',
# 	'superagentx.computer_use.browser_new.browser.screenshot_watchdog.ScreenshotWatchdog',
# ]
